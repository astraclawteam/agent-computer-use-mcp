...
The distribution contract is public npm plus a complete GitHub platform ZIP. Gitee Release is a byte-identical regional mirror. Windows x64 is the only enabled native target.
