...
Status: both known Level 1 composition blockers are repaired on `main`, and
Level 1 remains open until a real attempt verifies the sent result and final
idle state. The Host can compose the
